<template>
  <view class="content">
    <!-- <web-view update-title="false" src="https://www.baidu.com"></web-view> -->
    <div id="zhuti_1">
      <div id="biaoti">狗屁不通文章生成器</div>
      <div id="zhuti_2">
        <div class="hr">
          <span>主题：</span>
...
let quotes = [
  "郭德纲曾经聊过：穷人站在十字街头耍十把钢钩，钩不着亲人骨肉；有钱人在深山老林耍刀枪棍棒，打不散无义宾朋。英雄至此，未必英雄。",
  "郭德纲说谈过：泰坦尼克号沉了，对人类来说是一场巨大的灾难，但对船上餐厅里活着的海鲜来说就是生命的奇迹。",
  "京剧铡美案中有唱:驸马爷近前看端详，上写着秦香莲三十二岁，状告当朝驸马郎，欺君王，藐皇上，悔婚男儿招东床，杀妻灭子良心丧，逼死韩琪在庙堂，将状纸押至了爷的大堂上。",
  "罗翔老师说：自由其实是自我限制的自由，是可以节制的自由。自由一定要加以规范的限制，如果自由不加以限制，一定会导致强者对弱者的剥削。",
  "董宇辉说：努力不是为了证明自己多优秀，而是在意外和不可控的因素来临时，那些平常所努力积淀的涵养和能力，可以成为我们抗衡一切风雨的底气",
...
let theme = ["中午吃什么", "好好学习", "生活的意义", "科学和人文谁更有意义"];
